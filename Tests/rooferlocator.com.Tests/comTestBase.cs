...
namespace rooferlocator.com.Tests
{
    public abstract class comTestBase : AbpIntegratedTestBase
    {
        protected comTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<comApplicationModule>();
            modules.Add<comDataModule>();
        }

        public void UsingDbContext(Action<comDbContext> action)
        {
        ...
        public T UsingDbContext<T>(Func<comDbContext, T> func)
        {
            T result;
